...
var store_torrent= require('./storetorrent').storetorrent;
...
//        self.dataQueue.hash.push(hash);
        store_torrent.insertTorrent(hash);
    }
    ...
    setInterval(function(){
        store_torrent.getTopTorrent(1000, function(data){
            var cb = (function(data2){
                return function(d){
                    store_torrent.setTorrensReaded(data2);
                }
            })(data);
            _sendHash(data, cb);
        });
...
//        self.dataQueue.hash = [];
    ...
    function _sendHash(hashes, callback){
        ...
        console.log('send: hash' + hashes.length);
